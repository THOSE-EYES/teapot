...
namespace gl::shapes {
	...
	public:
		using Points = std::deque<std::deque<Point>>;
	...
	public:
		...
		void set_material(const std::shared_ptr<gl::materials::Material>& value) {
			if (material_ != value) material_ = value;
		}
	...
	private:
		...
		std::shared_ptr<gl::materials::Material> material_;
